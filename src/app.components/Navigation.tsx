		...
		<footer className="bg-w flex items-center h-[5.6rem] fixed bottom-0 max-w-[42rem] -translate-x-[2rem] mx-auto w-full border-solid border-t-[0.05rem] border-g3">
			<nav className="flex w-full">
				<ul className="flex justify-between mx-[3rem] w-full">
					<li role="presentation" className="flex flex-col items-center" onClick={() => router.push('/')}>
					...
					<li role="presentation" className="flex flex-col items-center" onClick={() => router.push('/calendar')}>
					...
					<li role="presentation" className="flex flex-col items-center">
						<BoardIcon stroke={`${router.pathname === '' ? '#66666E' : '#E8E8EB'}`} />
						<div className={`${router.pathname === '' ? 'text-[#66666E]' : 'text-[#E8E8EB]'}`}>게시판</div>
					</li>
					<li role="presentation" className="flex flex-col items-center" onClick={() => router.push('/mypage')}>
